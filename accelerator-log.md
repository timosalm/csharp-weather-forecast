...
```json
{
  ...
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=tsalm-vmware&repo=csharp-weather-forecast",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tsalm-vmware&repo=csharp-weather-forecast'
